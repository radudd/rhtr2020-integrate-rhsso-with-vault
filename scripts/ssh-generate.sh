...
ssh-keygen -t ed25519 -N '' -f config/backrest-key
...
# created keys
cat <<-EOF > templates/secret-backrest.yaml
apiVersion: v1
data:
  authorized_keys: ${PUBLIC_KEY}
  id_ed25519: ${PRIVATE_KEY}
  ssh_host_ed25519_key: ${PRIVATE_KEY}
  authorized_keys: `cat config/public`
  id_ed25519: `cat config/private`
  ssh_host_ed25519_key: `cat config/private`
...
metadata:
  ...
  name: postgresql-db-backrest-repo-config
type: Opaque
EOF
